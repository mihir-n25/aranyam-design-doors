  ...
  const workImages = [
    {
      ...
      title: "DarkSide",
      price: "From ₹1299",
      description: "This model can be made in a combination of veneer and enamel of these colors",
    },
    {
  ...
  return (
    <Main>
      ...
      <div className="imageComponents3">
        ...
        <h1>doors 003</h1>
        <h3>From ₹1299</h3>
        <p>This model can be made in a combination of veneer and enamel of these colors</p>
      </div>
      <div className="imageComponents2">
        {workImages2.map((workImage, index) => {
          return (
        ...
        <img 
          alt="colors-image"
          src="/images/Enamel.jpg"/>
          <h3>This model can be made in different versions according to your sizes. Our engineers and designers will help you choose the best option!</h3>
          <img 
          alt="doors-image"
          src="/images/view-desktop.svg"/>
          <h3>The unique construction technology of BURKOVSKY entrance doors is a barrier against all irritants that can disturb your comfort and harmony.</h3>
          <img 
