  ...
  return (
    <Main>
      ...
      <div className='about22'>
        ...
        <p>
       Our doors promise to safeguard your home while elevating its aesthetic appeal, making every entrance a grand welcome .
        </p>
        </div>
      </div>
      <div  ref={description}>
      <motion.div variants={opacity} animate={isInView ? "open" : "closed" }
       className='text1' style={{margin : '7rem'}} >
      Open the door to elegance and security
      </motion.div>
      <div className='text002'>
        <motion.p variants={slideUp} animate={isInView ? "open" : "closed"}>
        Ensuring quality craftsmanship, our doors are not just entrances, but statements of security and style, inviting you to step into a world of reliability .  Crafted with precision and durability in mind.
        </motion.p>
        <motion.p variants={slideUp} animate={isInView ? "open" : "closed"}>
       Our doors promise to safeguard your home while elevating its aesthetic appeal, making every entrance a grand welcome
        </motion.p>
      ...
      <div className='owner01'>
              <img src='mihir.png'/>
        <p>Inspired by a lifelong passion for craftsmanship and innovation, our founder envisioned a world where every doorway tells a story of quality and sophistication. With a relentless dedication to excellence, our owner leads by example, shaping the future of door design and security with unwavering commitment and vision. Through their visionary leadership, we strive to redefine the standards of elegance and reliability in every door we offer.</p>
      </div>
      <Magnetic>
